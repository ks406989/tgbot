...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "1144902"
    OWNER_ID = "754495556python3 -m tg_botpython3 -m tg_bot"  # If you dont know, run the bot and do /id in your private chat with it
    ...
    # OPTIONAL
    SUDO_USERS = [754495556]  # List of id's (not usernames) for users which have sudo access to the bot.
    SUPPORT_USERS = []  # List of id's (not usernames) for users which are allowed to gban, but can also be banned.
    WHITELIST_USERS = [754495556]  # List of id's (not usernames) for users which WONT be banned/kicked by the bot.
