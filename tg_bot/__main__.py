...
PM_START_TEXT = """
Hi {}, my name is {}! If you have any questions on how to use me, read /help - and then head to @Miss_Tinabot

I'm a group manager bot built in python3, using the python-telegram-bot library, and am fully opensource; \
you can find what makes me tick [here](t.me/HindiXstream)!

Feel free to submit pull requests on github, or to contact my support group, @Miss_Tinabot, with any bugs, questions \
...
There are two ways of paying him; [PayPal](paypal.me/kamleshkirodewal), or [Telegram](t.me/Kamlesh_Kirodewal)."""
